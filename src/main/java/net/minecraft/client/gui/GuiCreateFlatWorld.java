...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    {
        buttonList.clear();
        this.flatWorldTitle = LocalizationHelper.translate("createWorld.customize.flat.title");
        this.field_146394_i = LocalizationHelper.translate("createWorld.customize.flat.tile");
        this.field_146391_r = LocalizationHelper.translate("createWorld.customize.flat.height");
        this.createFlatWorldListSlotGui = new GuiCreateFlatWorld.Details();
        buttonList.add(this.field_146389_t = new GuiButton(2, this.width / 2 - 154, this.height - 52, 100, 20, LocalizationHelper.translate("createWorld.customize.flat.addLayer") + " (NYI)"));
        buttonList.add(this.field_146388_u = new GuiButton(3, this.width / 2 - 50, this.height - 52, 100, 20, LocalizationHelper.translate("createWorld.customize.flat.editLayer") + " (NYI)"));
        buttonList.add(this.field_146386_v = new GuiButton(4, this.width / 2 - 155, this.height - 52, 150, 20, LocalizationHelper.translate("createWorld.customize.flat.removeLayer")));
        buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height - 28, 150, 20, LocalizationHelper.translate("gui.done")));
        buttonList.add(new GuiButton(5, this.width / 2 + 5, this.height - 52, 150, 20, LocalizationHelper.translate("createWorld.customize.presets")));
    ...
    class Details extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            if (entryID == 0)
            {
                s1 = LocalizationHelper.translate("createWorld.customize.flat.layer.top", Integer.valueOf(flatlayerinfo.getLayerCount()));
            }
            else if (entryID == GuiCreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().size() - 1)
            {
                s1 = LocalizationHelper.translate("createWorld.customize.flat.layer.bottom", Integer.valueOf(flatlayerinfo.getLayerCount()));
            }
            else
            {
                s1 = LocalizationHelper.translate("createWorld.customize.flat.layer", Integer.valueOf(flatlayerinfo.getLayerCount()));
            }
