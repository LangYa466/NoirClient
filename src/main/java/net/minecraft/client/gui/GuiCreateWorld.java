...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public GuiCreateWorld(GuiScreen p_i46320_1_)
    {
        ...
        this.worldSeed = "";
        this.worldName = LocalizationHelper.translate("selectWorld.newWorld");
    }
    ...
    public void initGui()
    {
        ...
        buttonList.clear();
        buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height - 28, 150, 20, LocalizationHelper.translate("selectWorld.create")));
        buttonList.add(new GuiButton(1, this.width / 2 + 5, this.height - 28, 150, 20, LocalizationHelper.translate("gui.cancel")));
        buttonList.add(this.btnGameMode = new GuiButton(2, this.width / 2 - 75, 115, 150, 20, LocalizationHelper.translate("selectWorld.gameMode")));
        buttonList.add(this.btnMoreOptions = new GuiButton(3, this.width / 2 - 75, 187, 150, 20, LocalizationHelper.translate("selectWorld.moreWorldOptions")));
        buttonList.add(this.btnMapFeatures = new GuiButton(4, this.width / 2 - 155, 100, 150, 20, LocalizationHelper.translate("selectWorld.mapFeatures")));
        this.btnMapFeatures.visible = false;
        buttonList.add(this.btnBonusItems = new GuiButton(7, this.width / 2 + 5, 151, 150, 20, LocalizationHelper.translate("selectWorld.bonusItems")));
        this.btnBonusItems.visible = false;
        buttonList.add(this.btnMapType = new GuiButton(5, this.width / 2 + 5, 100, 150, 20, LocalizationHelper.translate("selectWorld.mapType")));
        this.btnMapType.visible = false;
        buttonList.add(this.btnAllowCommands = new GuiButton(6, this.width / 2 - 155, 151, 150, 20, LocalizationHelper.translate("selectWorld.allowCommands")));
        this.btnAllowCommands.visible = false;
        buttonList.add(this.btnCustomizeType = new GuiButton(8, this.width / 2 + 5, 120, 150, 20, LocalizationHelper.translate("selectWorld.customizeType")));
    ...
    {
        this.btnGameMode.displayString = LocalizationHelper.translate("selectWorld.gameMode") + ": " + LocalizationHelper.translate("selectWorld.gameMode." + this.gameMode);
        this.gameModeDesc1 = LocalizationHelper.translate("selectWorld.gameMode." + this.gameMode + ".line1");
        this.gameModeDesc2 = LocalizationHelper.translate("selectWorld.gameMode." + this.gameMode + ".line2");
        this.btnMapFeatures.displayString = LocalizationHelper.translate("selectWorld.mapFeatures") + " ";

        if (this.generateStructuresEnabled)
        {
            this.btnMapFeatures.displayString = this.btnMapFeatures.displayString + LocalizationHelper.translate("options.on");
        }
        else
        {
            this.btnMapFeatures.displayString = this.btnMapFeatures.displayString + LocalizationHelper.translate("options.off");
        }

        this.btnBonusItems.displayString = LocalizationHelper.translate("selectWorld.bonusItems") + " ";

        if (this.bonusChestEnabled && !this.hardCoreMode)
        {
            this.btnBonusItems.displayString = this.btnBonusItems.displayString + LocalizationHelper.translate("options.on");
        }
        else
        {
            this.btnBonusItems.displayString = this.btnBonusItems.displayString + LocalizationHelper.translate("options.off");
        }

        this.btnMapType.displayString = LocalizationHelper.translate("selectWorld.mapType") + " " + LocalizationHelper.translate(WorldType.worldTypes[this.selectedIndex].getTranslateName());
        this.btnAllowCommands.displayString = LocalizationHelper.translate("selectWorld.allowCommands") + " ";

        if (this.allowCheats && !this.hardCoreMode)
        {
            this.btnAllowCommands.displayString = this.btnAllowCommands.displayString + LocalizationHelper.translate("options.on");
        }
        else
        {
            this.btnAllowCommands.displayString = this.btnAllowCommands.displayString + LocalizationHelper.translate("options.off");
        }
    }
    ...
    private void showMoreWorldOptions(boolean toggle)
    {
        ...
        {
            this.btnMoreOptions.displayString = LocalizationHelper.translate("gui.done");
        }
        else
        {
            this.btnMoreOptions.displayString = LocalizationHelper.translate("selectWorld.moreWorldOptions");
        }
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        buttonList.get(0).enabled = this.worldNameField.getText().length() > 0;
        this.calcSaveDirName();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObject, LocalizationHelper.translate("selectWorld.create"), this.width / 2, 20, -1);

        if (this.inMoreWorldOptionsDisplay)
        {
            this.drawString(this.fontRendererObject, LocalizationHelper.translate("selectWorld.enterSeed"), this.width / 2 - 100, 47, -6250336);
            this.drawString(this.fontRendererObject, LocalizationHelper.translate("selectWorld.seedInfo"), this.width / 2 - 100, 85, -6250336);

            if (this.btnMapFeatures.visible)
            {
                this.drawString(this.fontRendererObject, LocalizationHelper.translate("selectWorld.mapFeatures.info"), this.width / 2 - 150, 122, -6250336);
            }

            if (this.btnAllowCommands.visible)
            {
                this.drawString(this.fontRendererObject, LocalizationHelper.translate("selectWorld.allowCommands.info"), this.width / 2 - 150, 172, -6250336);
            }
            ...
            {
                this.fontRendererObject.drawSplitString(LocalizationHelper.translate(WorldType.worldTypes[this.selectedIndex].getTranslatedInfo()), this.btnMapType.xPosition + 2, this.btnMapType.yPosition + 22, this.btnMapType.getButtonWidth(), 10526880);
            }
        }
        else
        {
            this.drawString(this.fontRendererObject, LocalizationHelper.translate("selectWorld.enterName"), this.width / 2 - 100, 47, -6250336);
            this.drawString(this.fontRendererObject, LocalizationHelper.translate("selectWorld.resultFolder") + " " + this.saveDirName, this.width / 2 - 100, 85, -6250336);
    ...
    {
        this.worldName = LocalizationHelper.translate("selectWorld.newWorld.copyOf", original.getWorldName());
