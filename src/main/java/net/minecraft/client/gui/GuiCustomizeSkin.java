...
public class GuiCustomizeSkin extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        {
            buttonList.add(new GuiCustomizeSkin.ButtonPart(enumplayermodelparts.getPartId(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), 150, 20, enumplayermodelparts));
            ++i;
        }
        ...
        buttonList.add(new GuiButton(210, this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), LocalizationHelper.translate("of.options.skinCustomisation.ofCape")));
        i = i + 2;
        buttonList.add(new GuiButton(200, this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), LocalizationHelper.translate("gui.done")));
    }
