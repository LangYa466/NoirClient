...
public class GuiEnchantment extends GuiContainer
{
    ...
    {
        this.fontRendererObject.drawString(this.field_175380_I.getDisplayName().getUnformattedText(), 12, 5, 4210752);
        ...
        for (int j = 0; j < 3; ++j)
        {
            ...
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0)
            {
                ...
                if (l >= 0 && Enchantment.getEnchantmentById(l & 255) != null)
                {
                    ...
                    list.add(EnumChatFormatting.WHITE.toString() + EnumChatFormatting.ITALIC + LocalizationHelper.translate("container.enchant.clue", s));
                }
                ...
                if (!flag)
                {
                    ...
                    else
                    {
                        ...
                        if (i1 == 1)
                        {
                            s1 = LocalizationHelper.translate("container.enchant.lapis.one");
                        }
                        else
                        {
                            s1 = LocalizationHelper.translate("container.enchant.lapis.many", Integer.valueOf(i1));
                        }
                        ...
                        if (i1 == 1)
                        {
                            s1 = LocalizationHelper.translate("container.enchant.level.one");
                        }
                        else
                        {
                            s1 = LocalizationHelper.translate("container.enchant.level.many", Integer.valueOf(i1));
                        }
