...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public GuiKeyBindingList(GuiControls controls, Minecraft mcIn)
    {
        ...
        for (KeyBinding keybinding : akeybinding)
        {
            ...
            int j = mcIn.fontRendererObj.getStringWidth(LocalizationHelper.translate(keybinding.getKeyDescription()));
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        {
            this.labelText = LocalizationHelper.translate(p_i45028_2_);
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        private KeyEntry(KeyBinding p_i45029_2_)
        {
            ...
            this.keyDesc = LocalizationHelper.translate(p_i45029_2_.getKeyDescription());
            this.btnChangeKeyBinding = new GuiButton(0, 0, 0, 75, 20, LocalizationHelper.translate(p_i45029_2_.getKeyDescription()));
            this.btnReset = new GuiButton(0, 0, 0, 50, 20, LocalizationHelper.translate("controls.reset"));
        }
