...
public class GuiMerchant extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        buttonList.add(this.nextButton = new GuiMerchant.MerchantButton(1, i + 120 + 27, j + 24 - 1, true));
        buttonList.add(this.previousButton = new GuiMerchant.MerchantButton(2, i + 36 - 19, j + 24 - 1, false));
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        this.fontRendererObject.drawString(LocalizationHelper.translate("container.inventory"), 8, this.ySize - 96 + 2, 4210752);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (merchantrecipelist != null && !merchantrecipelist.isEmpty())
        {
            ...
            this.itemRender.renderItemOverlays(this.fontRendererObject, itemstack, i + 36, j + 24);

            if (itemstack1 != null)
            {
                this.itemRender.renderItemAndEffectIntoGUI(itemstack1, i + 62, j + 24);
                this.itemRender.renderItemOverlays(this.fontRendererObject, itemstack1, i + 62, j + 24);
            }

            this.itemRender.renderItemAndEffectIntoGUI(itemstack2, i + 120, j + 24);
            this.itemRender.renderItemOverlays(this.fontRendererObject, itemstack2, i + 120, j + 24);
            ...
            {
                this.drawCreativeTabHoveringText(LocalizationHelper.translate("merchant.deprecated"), mouseX, mouseY);
            }
