...
public class GuiRepair extends GuiContainer implements ICrafting
{
    ...
    public void initGui()
    {
        ...
        this.nameField = new GuiTextField(0, this.fontRendererObject, i + 62, j + 24, 103, 12);
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        this.fontRendererObject.drawString(LocalizationHelper.translate("container.repair"), 60, 6, 4210752);

        if (this.anvil.maximumCost > 0)
        {
            int i = 8453920;
            boolean flag = true;
            String s = LocalizationHelper.translate("container.repair.cost", Integer.valueOf(this.anvil.maximumCost));

            if (this.anvil.maximumCost >= 40 && !this.mc.thePlayer.capabilities.isCreativeMode)
            {
                s = LocalizationHelper.translate("container.repair.expensive");
                i = 16736352;
            }
            ...
            if (flag)
            {
                ...
                int k = this.xSize - 8 - this.fontRendererObject.getStringWidth(s);
                int l = 67;

                if (this.fontRendererObject.getUnicodeFlag())
                {
                ...
                {
                    this.fontRendererObject.drawString(s, k, l + 1, j);
                    this.fontRendererObject.drawString(s, k + 1, l, j);
                    this.fontRendererObject.drawString(s, k + 1, l + 1, j);
                }

                this.fontRendererObject.drawString(s, k, l, i);
            }
        }
