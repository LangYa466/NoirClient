...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_175315_a = LocalizationHelper.translate("createWorld.customize.custom.presets.title");
        this.field_175313_s = LocalizationHelper.translate("createWorld.customize.presets.share");
        this.field_175312_t = LocalizationHelper.translate("createWorld.customize.presets.list");
        ...
        buttonList.add(this.field_175316_h = new GuiButton(0, this.width / 2 - 102, this.height - 27, 100, 20, LocalizationHelper.translate("createWorld.customize.presets.select")));
        buttonList.add(new GuiButton(1, this.width / 2 + 3, this.height - 27, 100, 20, LocalizationHelper.translate("gui.cancel")));
        this.func_175304_a();
    }
    ...
    static
    {
        ...
        field_175310_f.add(new GuiScreenCustomizePresets.Info(LocalizationHelper.translate("createWorld.customize.custom.preset.waterWorld"), resourcelocation, chunkprovidersettings$factory));
        ...
        field_175310_f.add(new GuiScreenCustomizePresets.Info(LocalizationHelper.translate("createWorld.customize.custom.preset.isleLand"), resourcelocation, chunkprovidersettings$factory));
        ...
        field_175310_f.add(new GuiScreenCustomizePresets.Info(LocalizationHelper.translate("createWorld.customize.custom.preset.caveDelight"), resourcelocation, chunkprovidersettings$factory));
        ...
        field_175310_f.add(new GuiScreenCustomizePresets.Info(LocalizationHelper.translate("createWorld.customize.custom.preset.mountains"), resourcelocation, chunkprovidersettings$factory));
        chunkprovidersettings$factory = ChunkProviderSettings.Factory.jsonToFactory("{\"coordinateScale\":684.412, \"heightScale\":684.412, \"upperLimitScale\":512.0, \"lowerLimitScale\":512.0, \"depthNoiseScaleX\":200.0, \"depthNoiseScaleZ\":200.0, \"depthNoiseScaleExponent\":0.5, \"mainNoiseScaleX\":1000.0, \"mainNoiseScaleY\":3000.0, \"mainNoiseScaleZ\":1000.0, \"baseSize\":8.5, \"stretchY\":10.0, \"biomeDepthWeight\":1.0, \"biomeDepthOffset\":0.0, \"biomeScaleWeight\":1.0, \"biomeScaleOffset\":0.0, \"useCaves\":true, \"useDungeons\":true, \"dungeonChance\":8, \"useStrongholds\":true, \"useVillages\":true, \"useMineShafts\":true, \"useTemples\":true, \"useRavines\":true, \"useWaterLakes\":true, \"waterLakeChance\":4, \"useLavaLakes\":true, \"lavaLakeChance\":80, \"useLavaOceans\":false, \"seaLevel\":20 }");
        resourcelocation = new ResourceLocation("textures/gui/presets/drought.png");
        field_175310_f.add(new GuiScreenCustomizePresets.Info(LocalizationHelper.translate("createWorld.customize.custom.preset.drought"), resourcelocation, chunkprovidersettings$factory));
        ...
        field_175310_f.add(new GuiScreenCustomizePresets.Info(LocalizationHelper.translate("createWorld.customize.custom.preset.caveChaos"), resourcelocation, chunkprovidersettings$factory));
        chunkprovidersettings$factory = ChunkProviderSettings.Factory.jsonToFactory("{\"coordinateScale\":684.412, \"heightScale\":684.412, \"upperLimitScale\":512.0, \"lowerLimitScale\":512.0, \"depthNoiseScaleX\":200.0, \"depthNoiseScaleZ\":200.0, \"depthNoiseScaleExponent\":0.5, \"mainNoiseScaleX\":80.0, \"mainNoiseScaleY\":160.0, \"mainNoiseScaleZ\":80.0, \"baseSize\":8.5, \"stretchY\":12.0, \"biomeDepthWeight\":1.0, \"biomeDepthOffset\":0.0, \"biomeScaleWeight\":1.0, \"biomeScaleOffset\":0.0, \"useCaves\":true, \"useDungeons\":true, \"dungeonChance\":8, \"useStrongholds\":true, \"useVillages\":true, \"useMineShafts\":true, \"useTemples\":true, \"useRavines\":true, \"useWaterLakes\":true, \"waterLakeChance\":4, \"useLavaLakes\":true, \"lavaLakeChance\":80, \"useLavaOceans\":true, \"seaLevel\":40 }");
        resourcelocation = new ResourceLocation("textures/gui/presets/luck.png");
        field_175310_f.add(new GuiScreenCustomizePresets.Info(LocalizationHelper.translate("createWorld.customize.custom.preset.goodLuck"), resourcelocation, chunkprovidersettings$factory));
    }
