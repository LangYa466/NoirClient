...
public class GuiScreenServerList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        buttonList.clear();
        buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, LocalizationHelper.translate("selectServer.select")));
        ...
        this.field_146302_g.setFocus(true);
        this.field_146302_g.setText(this.mc.gameSettings.lastServer);
        buttonList.get(0).enabled = this.field_146302_g.getText().length() > 0 && this.field_146302_g.getText().split(":").length > 0;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObject, LocalizationHelper.translate("selectServer.direct"), this.width / 2, 20, 16777215);
        this.drawString(this.fontRendererObject, LocalizationHelper.translate("addServer.enterIp"), this.width / 2 - 100, 100, 10526880);
