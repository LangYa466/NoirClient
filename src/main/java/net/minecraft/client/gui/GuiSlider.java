...
public class GuiSlider extends GuiButton
{
    ...
    {
        return this.formatHelper == null ? LocalizationHelper.translate(this.name) + ": " + this.func_175220_c() : this.formatHelper.getText(this.id, LocalizationHelper.translate(this.name), this.func_175220_c());
    }
