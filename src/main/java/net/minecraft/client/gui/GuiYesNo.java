...
public class GuiYesNo extends GuiScreen
{
    ...
    public GuiYesNo(GuiYesNoCallback p_i1082_1_, String p_i1082_2_, String p_i1082_3_, int p_i1082_4_)
    {
        ...
        this.confirmButtonText = LocalizationHelper.translate("gui.yes");
        this.cancelButtonText = LocalizationHelper.translate("gui.no");
    }
    ...
    public void initGui()
    {
        buttonList.add(new GuiOptionButton(0, this.width / 2 - 155, this.height / 6 + 96, this.confirmButtonText));
        buttonList.add(new GuiOptionButton(1, this.width / 2 - 155 + 160, this.height / 6 + 96, this.cancelButtonText));
