...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry
{
    ...
    {
        this.mc.fontRendererObj.drawString(LocalizationHelper.translate("lanServer.title"), x + 32 + 3, y + 1, 16777215);
        ...
        {
            this.mc.fontRendererObj.drawString(LocalizationHelper.translate("selectServer.hiddenAddress"), x + 32 + 3, y + 12 + 11, 3158064);
        }
        else
        {
