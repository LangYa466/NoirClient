...
public class ServerListEntryLanScan implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        this.mc.fontRendererObj.drawString(LocalizationHelper.translate("lanServer.scanning"), this.mc.currentScreen.width / 2 - this.mc.fontRendererObj.getStringWidth(LocalizationHelper.translate("lanServer.scanning")) / 2, i, 16777215);
        String s;
