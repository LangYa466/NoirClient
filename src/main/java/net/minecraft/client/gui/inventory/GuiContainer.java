...
public abstract class GuiContainer extends GuiScreen
{
    ...
    private void drawItemStack(ItemStack stack, int x, int y, String altText)
    {
        ...
        this.itemRender.renderItemOverlayIntoGUI(this.fontRendererObject, stack, x, y - (this.draggedStack == null ? 0 : 8), altText);
        this.zLevel = 0.0F;
    ...
    private void drawSlot(Slot slotIn)
    {
        ...
        if (!flag1)
        {
            ...
            this.itemRender.renderItemOverlayIntoGUI(this.fontRendererObject, itemstack, i, j, s);
        }
