...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    public void initGui()
    {
        if (this.mc.playerController.isInCreativeMode())
        {
            ...
            this.searchField = new GuiTextField(0, this.fontRendererObject, this.guiLeft + 82, this.guiTop + 6, 89, this.fontRendererObject.FONT_HEIGHT);
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (creativetabs.drawInForegroundOfTab())
        {
            ...
            this.fontRendererObject.drawString(LocalizationHelper.translate(creativetabs.getTranslatedTabLabel()), 8, 6, 4210752);
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            this.drawCreativeTabHoveringText(LocalizationHelper.translate("inventory.binSlot"), mouseX, mouseY);
        }
    ...
    protected void renderToolTip(ItemStack stack, int x, int y)
    {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex())
        {
            ...
            {
                list.add(1, "" + EnumChatFormatting.BOLD + EnumChatFormatting.BLUE + LocalizationHelper.translate(creativetabs.getTranslatedTabLabel()));
            }
    ...
    protected boolean renderCreativeInventoryHoveringText(CreativeTabs p_147052_1_, int p_147052_2_, int p_147052_3_)
    {
        ...
        {
            this.drawCreativeTabHoveringText(LocalizationHelper.translate(p_147052_1_.getTranslatedTabLabel()), p_147052_2_, p_147052_3_);
            return true;
        }
        else
        {
    ...
    protected void func_147051_a(CreativeTabs p_147051_1_)
    {
        ...
        this.itemRender.renderItemOverlays(this.fontRendererObject, itemstack, l, i1);
        GlStateManager.disableLighting();
