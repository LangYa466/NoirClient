...
public class GuiEditSign extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        buttonList.add(this.doneBtn = new GuiButton(0, this.width / 2 - 100, this.height / 4 + 120, LocalizationHelper.translate("gui.done")));
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        if (ChatAllowedCharacters.isAllowedCharacter(typedChar) && this.fontRendererObject.getStringWidth(s + typedChar) <= 90)
        {
            s = s + typedChar;
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObject, LocalizationHelper.translate("sign.edit"), this.width / 2, 40, 16777215);
