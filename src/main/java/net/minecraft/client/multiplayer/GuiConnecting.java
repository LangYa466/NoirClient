...
public class GuiConnecting extends GuiScreen
{
    ...
    {
        buttonList.clear();
        buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 120 + 12, LocalizationHelper.translate("gui.cancel")));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.networkManager == null)
        {
            this.drawCenteredString(this.fontRendererObject, LocalizationHelper.translate("connect.connecting"), this.width / 2, this.height / 2 - 50, 16777215);
        }
        else
        {
            this.drawCenteredString(this.fontRendererObject, LocalizationHelper.translate("connect.authorizing"), this.width / 2, this.height / 2 - 50, 16777215);
        }
