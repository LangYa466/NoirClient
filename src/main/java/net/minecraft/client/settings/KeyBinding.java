...
public class KeyBinding implements Comparable<KeyBinding>
{
    ...
    {
        int i = LocalizationHelper.translate(this.keyCategory).compareTo(LocalizationHelper.translate(p_compareTo_1_.keyCategory));

        if (i == 0)
        {
            i = LocalizationHelper.translate(this.keyDescription).compareTo(LocalizationHelper.translate(p_compareTo_1_.keyDescription));
        }
