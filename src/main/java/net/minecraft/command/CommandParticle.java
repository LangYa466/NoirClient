    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                double d6 = (float)parseDouble(vector3D.x(), args[1], true);
                double d0 = (float)parseDouble(vector3D.y(), args[2], true);
                double d1 = (float)parseDouble(vector3D.z(), args[3], true);
