...
public class MessageDeserializer extends ByteToMessageDecoder
{
    ...
    Marker RECEIVED_PACKET_MARKER = MarkerManager.getMarker("PACKET_RECEIVED").addParents(logMarkerPackets);
    ...
    protected void decode(ChannelHandlerContext p_decode_1_, ByteBuf p_decode_2_, List<Object> p_decode_3_) throws Exception
    {
        if (p_decode_2_.readableBytes() != 0)
        {
            ...
            IPacket packet = p_decode_1_.channel().attr(NetworkManager.attrKeyConnectionState).get().getPacket(this.direction, i);
