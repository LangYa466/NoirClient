...
public class GuiAnimationSettingsOF extends GuiScreen
{
    ...
    public void initGui()
    {
        this.title = LocalizationHelper.translate("of.options.animationsTitle");
        buttonList.clear();
        ...
        buttonList.add(new GuiButton(210, this.width / 2 - 155, this.height / 6 + 168 + 11, 70, 20, Lang.get("of.options.animation.allOn")));
        buttonList.add(new GuiButton(211, this.width / 2 - 155 + 80, this.height / 6 + 168 + 11, 70, 20, Lang.get("of.options.animation.allOff")));
        buttonList.add(new GuiOptionButton(200, this.width / 2 + 5, this.height / 6 + 168 + 11, LocalizationHelper.translate("gui.done")));
    }
