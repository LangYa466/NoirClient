...
public class GuiScreenCapeOF extends GuiScreenOF
{
    ...
    {
        int i = 0;
        this.title = LocalizationHelper.translate("of.options.capeOF.title");
        i = i + 2;
        buttonList.add(new GuiButtonOF(210, this.width / 2 - 155, this.height / 6 + 24 * (i >> 1), 150, 20, LocalizationHelper.translate("of.options.capeOF.openEditor")));
        buttonList.add(new GuiButtonOF(220, this.width / 2 - 155 + 160, this.height / 6 + 24 * (i >> 1), 150, 20, LocalizationHelper.translate("of.options.capeOF.reloadCape")));
        i = i + 6;
        this.buttonCopyLink = new GuiButtonOF(230, this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), 200, 20, LocalizationHelper.translate("of.options.capeOF.copyEditorLink"));
        this.buttonCopyLink.visible = this.linkUrl != null;
        buttonList.add(this.buttonCopyLink);
        i = i + 4;
        buttonList.add(new GuiButtonOF(200, this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), LocalizationHelper.translate("gui.done")));
    }
    ...
    protected void actionPerformed(GuiButton button)
    {
        if (button.enabled)
        {
            ...
            if (button.id == 210)
            {
                ...
                {
                    Config.showGuiMessage(LocalizationHelper.translate("of.message.capeOF.error1"), LocalizationHelper.translate("of.message.capeOF.error2", invalidcredentialsexception.getMessage()));
