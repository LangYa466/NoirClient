...
public class Reflector {
    ...
    public static ReflectorClass XGuiMainMenu = new ReflectorClass(GuiMainMenu.class);
    public static ReflectorField GuiMainMenu_splashText = new ReflectorField(XGuiMainMenu, String.class);
