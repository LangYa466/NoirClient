...
public class GuiShaders extends GuiScreenOF
{
    ...
    public void initGui()
    {
        this.screenTitle = LocalizationHelper.translate("of.options.shadersTitle");
        ...
        buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.ANTIALIASING, k, 0 + l, i, j));
        ...
        buttonList.add(new GuiButton(202, j1 / 4 * 3 - k1 / 2, this.height - 25, k1, j, LocalizationHelper.translate("gui.done")));
        buttonList.add(new GuiButton(203, k, this.height - 25, i, j, Lang.get("of.options.shaders.shaderOptions")));
        this.updateButtons();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        int i = this.fontRendererObject.getStringWidth(s);

        if (i < this.width - 5)
        {
            this.drawCenteredString(this.fontRendererObject, s, this.width / 2, this.height - 40, 8421504);
        }
        else
        {
            this.drawString(this.fontRendererObject, s, 5, this.height - 40, 8421504);
        }
    ...
    {
        this.drawCenteredString(this.fontRendererObject, text, x, y, color);
    }
